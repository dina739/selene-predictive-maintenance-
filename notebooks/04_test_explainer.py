"""
Explainable NLP Module - Using GroqCloud Free Tier (Updated March 2025)
...
class MaintenanceExplainer:
    def __init__(self, model="llama-3.3-70b-versatile"):  # Updated active model!
        ...
        if not self.api_key:
            ...
            self.model = model
            print(f"✅ GroqCloud client initialized with model: {self.model}")
...
NOTE: Connect to GroqCloud API for detailed AI-powered explanations.
      ...
      Active models: llama-3.3-70b-versatile, llama-3.1-8b-instant, gemma2-9b-it
...
if __name__ == "__main__":
    ...
    # - "llama-3.3-70b-versatile" (best for detailed advice)
    # - "llama-3.1-8b-instant" (fastest)
    # - "gemma2-9b-it" (balanced)
    # - "deepseek-r1-distill-llama-70b" (DeepSeek style)
    
    explainer = MaintenanceExplainer(model="llama-3.3-70b-versatile")
